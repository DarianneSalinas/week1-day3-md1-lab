...
if (amysAge > brittanisAge) {
    ...
    console.log("Age is undetermined")
}
...
if (temperature >= 80 && rain) {
    console.log("Wear a t-shirt, light jacket, and bring an umbrella!")
...
var num = 10;
for (let i = 10; i > 0; i--) {
    // console.log(`${i}`) not this one do the one below
    console.log(i)
}
////////// PROBLEM 8 //////////
...
if (changeMyMind) {
    changeMyMind = false;
    console.log(`changeMyMind variable status is ${changeMyMind} `)
} else {
    changeMyMind = true;
}
